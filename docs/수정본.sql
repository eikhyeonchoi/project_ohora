...
cdt       DATETIME NULL     DEFAULT CURRENT_TIMESTAMP COMMENT '작성일' -- 작성일
)
COMMENT '매뉴얼 댓글';
...
qtype_no INTEGER NOT NULL COMMENT '질문 유형 번호', -- 질문 유형 번호
conts    varchar(30) NOT NULL COMMENT '유형명' -- 유형명
)
COMMENT '고객문의유형';
...
udt     DATETIME NULL     DEFAULT CURRENT_TIMESTAMP COMMENT '백업일' -- 백업일
)
COMMENT '팁 히스토리';
