...
insert into member(email, pwd, name, tel, n_name, type, ban) values('company2@test.com','2222','기업회원2','1234-1234','기업회원2',2,false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('company3@test.com','3333','기업회원3','1234-1234','기업회원3',2,false);
