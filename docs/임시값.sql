...
-- member 임시값 '회원'
insert into member(email, pwd, name, tel, n_name, type, ban) values('user1@test.com',password('1111'),'김지성','1234-1234','일반회원1','일반 회원',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('user2@test.com',password('2222'),'김의주','2222-2222','일반회원2','일반 회원',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('user3@test.com',password('3333'),'우승완','3333-3333','일반회원3','일반 회원',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('company1@test.com',password('1111'),'이대구','1234-1234','기업회원1','기업 회원',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('company2@test.com',password('2222'),'최익현','1234-1234','기업회원2','기업 회원',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('company3@test.com',password('3333'),'사나','1234-1234','기업회원3','기업 회원',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('manager1@test.com',password('1111'),'모모','1234-1234','관리자1','관리자',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('manager2@test.com',password('2222'),'쯔위','1234-1234','관리자2','관리자',false);
insert into member(email, pwd, name, tel, n_name, type, ban) values('manager3@test.com',password('3333'),'지효','1234-1234','관리자3','관리자',false);
