...
@MapperScan("bitcamp.team.third.dao")
public class MybatisConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(DataSource dataSource, ApplicationContext appCtx)
    ...
    factoryBean.setTypeAliasesPackage("bitcamp.team.third.domain");
    factoryBean.setMapperLocations(appCtx.getResources("classpath:/third/mapper/*.xml"));
