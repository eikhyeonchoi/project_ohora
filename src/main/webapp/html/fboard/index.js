...
var tbody = $('tbody'), page = $('.page-container'), templateSrc = $(
    '#tr-template').html(), trGenerator = Handlebars.compile(templateSrc);
...
function loadList(type, keyword) {
  $.getJSON('/bitcamp-team-project/app/json/fboard/list?type=' + type
      + "&keyword=" + keyword, function(obj) {
    page.pagination({
      dataSource : obj,
      locator : 'list',
      showGoInput : true,
